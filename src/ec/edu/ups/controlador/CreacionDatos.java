...
public class CreacionDatos implements Serializable{
	...
	public void creacionPrincipal() {
		...
		ejbProducto.create(pord);
		ejbProducto.create(pord2);
		ejbProducto.create(pord3);
		ejbProducto.create(pord4);
		ejbProducto.create(pord5);
		ejbProducto.create(pord6);
		ejbProducto.create(pord7);
		ejbProducto.create(pord8);
		ejbProducto.create(pord9);
		ejbProducto.create(pord10);
		ejbProducto.create(pord11);
		ejbProducto.create(pord12);
		ejbProducto.create(pord13);
		ejbProducto.create(pord14);
		ejbProducto.create(pord15);
		ejbProducto.create(pord16);
		ejbProducto.create(pord17);
		ejbProducto.create(pord18);
		ejbProducto.create(pord19);
		ejbProducto.create(pord20);
		ejbProducto.create(pord21);
		ejbProducto.create(pord22);
		ejbProducto.create(pord23);
		ejbProducto.create(pord24);
		ejbProducto.create(pord25);
	...
	public void creacionSecundaria() {
		...
		ejbBodega.edit(bodega);
		ejbBodega.edit(bodega2);
		ejbBodega.edit(bodega3);
